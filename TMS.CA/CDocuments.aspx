<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="CDocuments.aspx.cs" Inherits="TMS.CA.CDocuments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <h5 class="mb-0"><strong>Client Documents</strong></h5>
    <span class="text-secondary">Dashboard <i class="fa fa-angle-right"></i>&nbsp;Client Documents</span>
    <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
        <div class="product-list">
            <div class="row border-bottom mb-4">
                <div class="col-sm-8 pt-2">
                    <h6 class="mb-4 bc-header">Client Documents</h6>
                </div>
                <div class="col-sm-4 text-right pb-3">
                    <a href="ClientsList.aspx" class="btn btn-round btn-theme"><i class="fa fa-list"></i>&nbsp;Cliets List</a>
                </div>
            </div>
            <div class="col-sm-12">
                <div class="row mt-4">
                    <div class="col-sm-12">
                        <div class="form-group row">
                            <div class="col-sm-4 col-12">
                                ...
                                <asp:DropDownList ID="ddlClients" runat="server" CssClass="custom-select" OnSelectedIndexChanged="ddlClients_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                            <div class="col-sm-4 col-12">
